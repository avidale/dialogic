...
from dialogic.storage.database_utils import fix_bson_keys
from dialogic.utils import database_utils
...
class MongoBasedStorage(BaseStorage):
    ...
    def __init__(self, database=None, collection_name='sessions', collection=None):
        assert database is not None or collection is not None
